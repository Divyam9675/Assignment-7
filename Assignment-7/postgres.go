...
//The basic use case for gorp is to define some structs and then register them with an instance of gorp’s DbMap structure

var dbmap = initDb()

func initDb() *gorp.DbMap {
	db, err := sql.Open("postgres", "postgres://postgres:admin@localhost/progress?sslmode=disable")
